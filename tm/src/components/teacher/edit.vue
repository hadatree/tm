    ...
    export default {
        ...
        mounted() {
            ...
            axios({
                ...
                method: 'get',
                data: {
                    _id: this.$route.query.tid
                }
            }).then(res => {
                for (var i = 0; i < res.data.teacher.length; i++) {
                    if (res.data.teacher[i]._id == self.$route.query.tid) {
                        console.log(2)
                        console.log(res.data.teacher[i]);
                        self.t = res.data.teacher[i]
                        break;
                    }
                }
            })
            ...
            $("form").on("submit", e => {
                ...
                data.append('_id', self.$route.query.tid)
                    // console.log(data)
                axios
                    .post("/api/teacher/edit", data, {
                        header: {
